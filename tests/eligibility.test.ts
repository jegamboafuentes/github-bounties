...
import type { EligibilityInput } from "../src/types.js";
...
const cases = JSON.parse(
  readFileSync(
    join(dirname(fileURLToPath(import.meta.url)), "../fixtures/eligibility-cases.json"),
    "utf8",
  ),
) as Case[];
