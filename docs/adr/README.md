...
| [0003](./0003-v2-multi-hunter-pool.md) | V2 multi-hunter participation pool | **Accepted** (V2-0 math + V2-1 schema + V2-2 freeze + V2-3 settle; V2-4…V2-5 not wired) |

[0003](./0003-v2-multi-hunter-pool.md) supersedes the ADR 0001 V2 sketch (`pool ≈ 0.15 × F`). Frozen math is **15% of post-fee**. Tickets: [docs/v2-tickets.md](../v2-tickets.md). V2-0 is fixtures + `splitPostFeePool`. V2-1 is the additive schema. V2-2 freezes `E` on winning merge. V2-3 is multi-payee `settleEscrow`. Exclusive 72h claim-lock sunset is V2-4. V1.5 WalletConnect + amount chips is parallel polish after x402 [#29](https://github.com/jegamboafuentes/github-bounties/pull/29) and does not block 0003.
