...
export function PayoutBreakdown({
  ...
  const pies = payoutPiesFromBreakdown(breakdown);
  ...
  return (
    <section className="flex flex-col gap-3 rounded-xl border border-zinc-200 bg-white p-4 dark:border-zinc-800 dark:bg-zinc-900">
      ...
      <div className="flex flex-col gap-3 sm:flex-row sm:items-start">
        <PayoutPieCharts face={pies.face} postFee={pies.postFee} />
        <dl className="min-w-0 flex-1 divide-y divide-zinc-200 overflow-hidden rounded-lg border border-zinc-200 text-sm dark:divide-zinc-800 dark:border-zinc-800">
